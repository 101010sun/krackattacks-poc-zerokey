...
class MitmSocket(L2Socket):
	...
	def recv(self, x=MTU):
		...
		# 總結: 如果 channel flag 沒有出現，但是 rate flag 出現, 代表這是 echoed injected frame.
		# 應該有更多 flag 可以判斷是否為我們注入的 frame (cross-channel)
		...
		# !-- Strip the FCS if present, and drop the RadioTap header, will make package wrong?
		result = p[Dot11]
		return result
